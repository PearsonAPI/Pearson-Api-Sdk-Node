...
Endpoint.prototype.searchFrisby = function(json, offset, limit){ // This is for the Frisbee tests to separate the url function from the api call.
    'use strict';
    var query;
    var fullUrl;
    if (typeof json === 'undefined') {
...
Endpoint.prototype.getByIdFrisby = function(Id) { // Again, this is purely for testing purposes so that Frisby handles the api request.
    'use strict';
